					...
					<form action="islemler/ajax.php" method="POST" accept-charset="utf-8">
						<div class="form-row">
							<div class="col-md-6 form-group">
								...
								<input value="<?php echo $kullanicibilgisi['kul_isim'] ?>" type="text" name="kul_isim"
						...
						<div class="form-row">
							<div class="col-md-6 form-group">
								...
								<input value="<?php echo $kullanicibilgisi['kul_mail'] ?>" type="email" name="kul_mail"
									placeholder="Mail Adresi" class="form-control">
							</div>
						</div>
						<div class="form-row">
							<div class="col-md-6 form-group">
								<label>Telefon</label>
								<input value="<?php echo $kullanicibilgisi['kul_telefon'] ?>" type="text"
