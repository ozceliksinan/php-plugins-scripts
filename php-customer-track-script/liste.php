...
<?php foreach($mesajlar as $key => $mesaj): ?>
	<div <?php if($mesaj['mesaj_gonderen'] == $_SESSION['kul_id']): ?>
			style="background-color: #4e73df; color: white; font-size: 14px;" class="mesaj ml-auto" <?php else: ?> class="mesaj"
		<?php endif ?>>
