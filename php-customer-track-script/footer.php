    ...
    <div class="card-footer p-1 my-3">
      ...
      <div id="mesaj-sayisi-alani" style="display: none;">
        ...
        <div class="d-flex justify-content-center text-center">
          <div class="">
            <input type="radio" id="son50" class="mesaj-sayisi" checked="" name="mesaj_sayisi" value="son50"> <label
              for="son50">Son 50</label>
          </div>
          <div class="mx-2">
            <input type="radio" id="son100" class="mesaj-sayisi" name="mesaj_sayisi" value="son100"> <label
              for="son100">Son 100</label>
          </div>
          <div>
            <input type="radio" id="hepsi" class="mesaj-sayisi" name="mesaj_sayisi" value="hepsi"> <label
              for="hepsi">Hepsi</label>
          </div>
        </div>
      </div>
    </div>
...
<footer class="sticky-footer bg-white">
  <div class="container my-auto">
    <div class="copyright text-center my-auto">
      <span>Copyright &copy; <?php echo $ayarcek['site_baslik'] ?> <?php echo date("Y"); ?> </span>
    </div>
  </div>
</footer>
<!-- End of Footer -->
