  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      ...
      <div class="justify-content-start d-flex text-left">
        ...
        <a href="musteriyukle.php" class="ml-2 mb-2"><button type="button" class="btn btn-danger btn-sm">Müşteri
            Yükle</button></a>
        ...
        <form action="islemler/ajax.php" method="POST" accept-charset="utf-8">
          <button type="submit" class="btn btn-warning btn-sm ml-2" name="isim-mail-telefon-aktar">İsim-Mail-Telefon
            Aktar</button>
        </form>
      </div>
        ...
        <table class="table table-bordered" id="musteritablosu">
          ...
          <tbody>
            ...
            while($musteribilgisi = $sorgu->fetch(PDO::FETCH_ASSOC)) {
              ...
              <tr>
                <td>
                  <?php echo $musteribilgisi['musteri_id'];
                  ; ?>
                </td>
                <td>
                  <?php echo $musteribilgisi['musteri_isim']; ?>
                </td>
                <td>
                  <?php echo $musteribilgisi['musteri_mail']; ?>
                </td>
                <td>
                  <?php echo $musteribilgisi['musteri_telefon']; ?>
                </td>
                <td>
                  <?php echo $musteribilgisi['musteri_sehir']; ?>
                </td>
                <td>
                  <?php echo $musteribilgisi['musteri_meslek']; ?>
                </td>
                <td>
