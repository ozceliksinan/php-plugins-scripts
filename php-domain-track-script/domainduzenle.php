					...
					<form action="islemler/ajax.php" method="POST" accept-charset="utf-8">
						<div class="form-row">
							<div class="col-md-4 form-group">
								...
								<input type="text" name="domain_adi" class="form-control" placeholder="Domain Adı"
									value="<?php echo $domain['domain_adi'] ?>">
							</div>
							<div class="col-md-4 form-group">
							...
							<div class="col-md-4 form-group">
								...
								<input type="date" name="domain_baslangic" class="form-control"
						...
						<div class="form-row">
							<div class="col-md-4 form-group">
								...
								<input type="text" name="domain_kayit_firmasi" class="form-control"
									placeholder="Kayıt Firması" value="<?php echo $domain['domain_kayit_firmasi'] ?>">
							</div>
							<div class="col-md-4 form-group">
								<label>Domain Bitiş Tarihi</label>
								<input type="date" name="domain_bitis" class="form-control"
							...
							<div class="col-md-4 form-group">
								...
								<input type="text" name="domain_fiyat" class="form-control" placeholder="Domain Fiyat"
									value="<?php echo $domain['domain_fiyat'] ?>">
							</div>
						</div>
